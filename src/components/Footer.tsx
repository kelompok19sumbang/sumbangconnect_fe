...
export default function Footer() {
  return (
    <footer className="bg-navy text-cream border-t border-white/10 relative overflow-hidden">
      ...
      {/* Garis Sweeping Melintasi Footer untuk kesan mengalir */}
      ...
      {/* Titik-titik Minimalis Kanan Atas */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="space-y-4">
            ...
            <a href="#" className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 hover:bg-white/10 hover:text-accent transition-colors text-sm w-fit">
