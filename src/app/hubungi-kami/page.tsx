...
export default async function HubungiKamiPage() {
  ...
  // Format nomor telepon untuk link WhatsApp (hapus strip/spasi, ganti 0 dengan 62)
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-16 relative z-20">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl shadow-navy/5 border border-navy/10 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
            ...
            <p className="text-navy/70 leading-relaxed font-medium mb-6">
              {alamat}
            </p>
            <a 
              ...
              className="mt-auto bg-blue-primary/10 text-blue-primary px-6 py-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-primary hover:text-white transition-colors w-full"
            >
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl shadow-navy/5 border border-navy/10 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="mt-auto bg-[#25D366] text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 hover:bg-[#128C7E] transition-colors w-full justify-center"
            >
          ...
          {/* Kartu 3: Email & Sosmed */}
          <div className="bg-white rounded-3xl p-8 shadow-xl shadow-navy/5 border border-navy/10 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
            <div className="w-16 h-16 bg-navy/5 text-navy rounded-full flex items-center justify-center mb-6">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            </div>
            <h3 className="text-2xl font-bold text-navy mb-4 font-serif">Email & Sosmed</h3>
            <p className="text-navy/70 leading-relaxed font-medium mb-6">
              {email}
            </p>
            <div className="mt-auto w-full flex gap-2">
              <a 
                href={`mailto:${email}`}
                className="flex-[2] bg-navy/5 text-navy px-2 py-3 rounded-xl font-bold hover:bg-navy hover:text-white transition-colors flex items-center justify-center text-sm lg:text-base"
              >
                Kirim Email
              </a>
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-[#E1306C]/10 text-[#E1306C] px-2 py-3 rounded-xl font-bold hover:bg-[#E1306C] hover:text-white transition-colors flex items-center justify-center"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-[#1877F2]/10 text-[#1877F2] px-2 py-3 rounded-xl font-bold hover:bg-[#1877F2] hover:text-white transition-colors flex items-center justify-center"
              >
