...
export default async function Footer() {
  ...
  // 🔥 Tambahkan parsing link Facebook dari Strapi
  let linkFb = data?.link_facebook || "#";
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="space-y-4">
            ...
            {/* Bungkus tombol sosmed dengan flex-col supaya rapi */}
            <div className="flex flex-col gap-3">
              <a href={linkIg} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 hover:bg-[#E1306C] hover:border-[#E1306C] hover:text-white transition-colors text-sm w-fit">
              ...
              <a href={linkFb} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-colors text-sm w-fit">
