        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl shadow-navy/5 border border-navy/10 flex flex-col items-center text-center hover:-translate-y-2 transition-transform duration-300">
            ...
            <div className="mt-auto w-full flex gap-3">
              <a 
                href={`mailto:${email}`}
                className="flex-1 bg-navy/5 text-navy px-4 py-3 rounded-xl font-bold hover:bg-navy hover:text-white transition-colors flex items-center justify-center"
              >
                Kirim Email
              </a>
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-[#E1306C]/10 text-[#E1306C] px-4 py-3 rounded-xl font-bold hover:bg-[#E1306C] hover:text-white transition-colors flex items-center justify-center gap-2"
              >
