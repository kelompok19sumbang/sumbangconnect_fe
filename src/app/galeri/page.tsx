...
import PenghargaanCard from '@/components/PenghargaanCard'; // 🔥 Panggil komponen Card Modal kita
...
export default async function GaleriPage() {
  ...
  // 🔥 Fungsi untuk merapikan format tanggal
            ...
            {dataPenghargaan && dataPenghargaan.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                {dataPenghargaan.map((item: any) => {
                  ...
                  const teksDeskripsi = extractTextFromBlocks(deskripsiRaw);
                  ...
                  return (
                    <PenghargaanCard 
                      ...
                      judul={judul}
                      tanggal={tanggalRaw ? formatTanggal(tanggalRaw) : ''}
                      deskripsi={teksDeskripsi}
                      fotoUrl={fotoUrl}
                    />
                  );
                })}
